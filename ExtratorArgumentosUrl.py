class ExtratorArgumentosUrl:
    ...
    @staticmethod #metodo estatico, pra tirar o self sem uso.
    def urlEhValida(url):
    ...
    def trocaMoedaOrigem(self):
        self.url = self.url.replace("moedasdestino", "real", 1)
        print(self.url)

    def extraiValor(self):
        buscaValor = "valor="
        indiceInicialValorv = self.encontraIndiceInicial(buscaValor)
        valor = self.url[indiceInicialValorv:]
        return valor